...
#all urls from 2009 (our selection)
#url_list = open('/prosjekt/nrk/url-lister/all-urls-2009')
#all okonomi-urls from 2006- (nrk's selection)
#url_list = open('/prosjekt/nrk/url-lister/urls-okonomi-2009.txt')
#urls_i_nrk13_men_ikke_i_uib14
#nrk complement to our 14day-selection
...
#------
	...
	while 2:
		...
		if not linje:
            ...
            # remove paths from filename
			fn=fn.replace("/prosjekt/nrk/innhausting/2009/stripfiler/", "")
